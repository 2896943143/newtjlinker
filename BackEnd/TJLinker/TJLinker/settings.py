"""
Django settings for TJLinker project.
...
SECRET_KEY = "django-insecure-#j^i2vbt%j_8e^#oqk*o8s(to%ko%(*is7&2e64i%xj@tl2@$c"
...
WSGI_APPLICATION = "TJLinker.wsgi.application"
